...
```{r global, echo = FALSE, message = FALSE, dpi=300, out.width = '70%'}
...
The graph \@ref(fig:global) shows the worldwide trend of Nutritional Deficiencies from the year 1990. The trend is downward which means that the number of deaths have decreased over these years.
