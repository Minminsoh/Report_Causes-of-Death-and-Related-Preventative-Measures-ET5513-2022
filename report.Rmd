...
```{r HIV, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Death trends from HIV/AIDS in those 5 Countries"}
...
HIV_AIDS %>% filter (Entity %in% c("South Africa", "Kenya","Tanzania", "India" , "Nigeria" ))%>%
  ...
  theme_minimal()
```
Figure \@ref(fig:HIV) depicts the death rates from HIV/AIDS for the 5 countries listed in the table above. Each country appears to follow the global death rate trend of increasing from the 1990s to the 2000s, before decreasing from 2005 to 2020. This is highly evident in South Africa and India. 
...
ART  %>% filter (Entity %in% c( "South Africa", "Kenya","Tanzania", "India" , "Nigeria" ))%>%
