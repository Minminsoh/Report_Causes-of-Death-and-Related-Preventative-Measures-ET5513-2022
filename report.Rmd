...
```
Figure \@ref(fig:countrygraph) shows the death rate trend by countries from 2000 to 2019. Overall, the trend was decreasing over the years with fluctuations in some of the countries. The reason for the downward trend could be the increase in the population with access of insecticide in malaria prevalent countries from 7% to 67% in 2015 (@MalariaTrend). 
